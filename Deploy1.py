...
BMI = st.sidebar.number_input('Enter Your Body Mass Index',1,100)
...
PhysicalHealth = st.sidebar.number_input('What is your physical health condition?',1,30)
MentalHealth = st.sidebar.number_input('What is your mental health condition?',1,30)
...
SleepTime = st.sidebar.number_input('How many hours you sleep in a day?',1,24)
